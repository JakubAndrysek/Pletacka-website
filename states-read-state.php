...
<div class="container-fluid text-center">
    ...
    <form name="testForm" action="" method="">
      Nazev senzoru: 
      <input type="text" name="sen-name" id="sen-name" onkeyup="showSensorsTable()">
      <input type="text" name="sen-state" id="sen-state" onkeyup="showSensorsTable()">
